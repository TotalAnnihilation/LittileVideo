...
public class MainActivity extends AppCompatActivity {
    ...
    private final int SOURCE_APIOPEN = 0;
    private int mSourceType = SOURCE_APIOPEN;
...
//        });
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (title.equals(getString(R.string.apiopen_name))) {
        ...
        public void bind(PhotoItem photoItem) {
            ...
            if (mPhotoItem.isAvailability()) {
                ...
                if (bitmap != null) {
                    ...
                    LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mImageViewPhoto.getLayoutParams();//获取你要填充图片的布局的layoutParam
                ...
                System.out.println(mPhotoItem);
                LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mImageViewPhoto.getLayoutParams();//获取你要填充图片的布局的layoutParam
                layoutParams.height = 0;
                layoutParams.width = 0;
                mImageViewPhoto.setLayoutParams(layoutParams);
                mTextViewName.setLayoutParams(layoutParams);
